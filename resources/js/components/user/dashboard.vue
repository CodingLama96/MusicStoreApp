    ...
    <div class="container mx-auto p-4">
      ...
      <div class="bg-green-100 p-6 rounded-md">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <router-link to="/user/showAlbums" class="bg-white p-4 rounded-md text-green-500 font-bold text-lg hover:underline">
          ...
          <router-link to="/user/showPurchasedAlbums" class="bg-white p-4 rounded-md text-green-500 font-bold text-lg hover:underline">
            <div class="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                class="w-6 h-6 mr-2">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
